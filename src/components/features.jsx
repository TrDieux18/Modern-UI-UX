...
const features = [
  {
    ...
    description:
      "Intelligent code suggestions that boost your productivity and help you write better code faster. Get real-time code completions powered by advanced AI algorithms.",
  ...
  },
  {
    ...
    description:
      "Streamline your testing process with intelligent test generation and execution. Identify bugs early and ensure code quality with our AI-powered testing solutions.",
  ...
  },
  {
    ...
    description:
      "Accelerate your debugging process with AI-powered insights and real-time error detection. Resolve issues faster and improve your code quality.",
    codeSnippet: `// AI suggests potential fixes
try {
                  ...
                  "
                    >
                      ...
                      <div className="bg-gray-950 rounded-lg p-3 sm:p-4 font-mono text-xs sm:text-sm">
                        <div className="flex items-center space-x-1 sm:space-2 mb-3 sm:mb-4">
